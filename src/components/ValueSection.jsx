            ...
            <div className="grid grid-cols-4 gap-4">
                ...
                <div className="col-span-1 bg-transparent">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] p-4 rounded-lg" src={logo1}></img>
                    </div>
                ...
                <div className="col-span-1 bg-transparent">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] p-4 rounded-lg" src={logo2}></img>
                    </div>
                ...
                <div className="col-span-1 bg-transparent">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] p-4 rounded-lg" src={logo3}></img>
                    </div>
                ...
                <div className="col-span-1 bg-transparent">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] p-4 rounded-lg" src={logo4}></img>
                    </div>
                ...
                <div className="col-span-1 bg-transparent mt-12">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] rounded-lg p-4" src={logo5}></img>
                    </div>
                ...
                <div className="col-span-1 bg-transparent mt-12">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] rounded-lg p-4" src={logo6}></img>
                    </div>
                ...
                <div className="col-span-1 bg-transparent mt-12">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] rounded-lg p-4 mb-4" src={logo7}></img>
                    </div>
                ...
                <div className="col-span-1 bg-transparent mt-12">
                    <div className="flex items-center justify-center mb-4">
                        <img className="border border-[#f89500] rounded-lg p-4 mb-4" src={logo8}></img>
                    </div>
