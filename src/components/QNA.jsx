...
export const QNA = ({question, answer}) => {
  ...
  return (
    <div className={clicked ? ' mb-4 ml-24 mr-16 border border-[#f89500] rounded-xl py-4 px-7 cursor-pointer bg-[#ff0000]':' mb-4 ml-24 mr-16 border border-[#f89500] rounded-xl py-4 px-7 cursor-pointer'}>
