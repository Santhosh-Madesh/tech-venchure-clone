...
export default function HeroSection(){
    ...
    return(
        <div className="my-20 ml-30 mr-12">
        <div className="flex justify-between items-center text-white text-left">
            <div className="space-y-8">
                <div className="bg-gradient-to-r from-[#fbfaf9] to-[#cbbab5] text-transparent bg-clip-text">
                    <h2 className="font-creato text-7xl font-medium font-">Experience <br></br>the Future</h2>
                </div>
                <p className="text-sm">AI-Powered Marketing, Your Pathway to<br></br>
